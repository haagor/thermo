...
./bin/main: ./bin/main.o ./bin/utils.o ./bin/matrix.o ./bin/e0/heaTransfert.o ./bin/e1/heaTransfert.o ./bin/e2/heaTransfert.o
	@mkdir -p bin
	$(CC) $(CCFLAGS) -o ./bin/main $^ -lpthread

./bin/main.o: ./src/main.c ./src/utils.h ./src/e0/heaTransfert.h ./src/e1/heaTransfert.h ./src/e2/heaTransfert.h
	@mkdir -p bin
